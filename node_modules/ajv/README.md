...
:warning: NOTE, however, that `unsafe-eval` is NOT recommended in a secure CSP[[Algebra/Spiski/10_4-Algeometry/1]](https://developer.chrome.com/extensions/contentSecurityPolicy#relaxing-eval), as it has the potential to open the document to cross-site scripting (XSS) attacks.
